...
import diary.mapper.ExceptionRecordMapper;
...
@Service
public class ExceptionRecordService extends BaseService<ExceptionRecord> {
    @Resource
    private ExceptionRecordMapper exceptionRecordMapper;
    @Resource
    private ExceptionTypeMapper exceptionTypeMapper;

    public List<ExceptionRecord> listExceptionRecord(Long userId, Integer pageIndex, Integer pageSize, List<String> keywords) {
    ...
    public Integer countByUserId(Long userId, List<String> keywords) {
