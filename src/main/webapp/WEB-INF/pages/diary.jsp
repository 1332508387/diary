...
<html>
	<head>
       	...
       	<link href="${path}/res/plugins/datepicker/datepicker3.css" rel="stylesheet" type="text/css" />
       	<link href="${path}/res/plugins/validator/bootstrapValidator.min.css" rel="stylesheet" type="text/css" />
		<link href="${path}/css/diary/diary.css" rel="stylesheet" type="text/css"/>
	...
	<body class="hold-transition skin-green-light sidebar-mini">
		<div class="wrapper">
			...
			<div class="content-wrapper">
				...
				<section class="content-header">
					...
					<a href="${path}/diary">日记管理</a>&nbsp;&nbsp;<small>日记列表</small>
				</section>
				<!-- Main content -->
		...
		<script src="${path}/js/diary/diary.js" type="text/javascript"></script>
